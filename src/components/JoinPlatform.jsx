...
export default function JoinPlatformPopup({ open, setOpen, buttonName }) {
  ...
  const modalContent = open
    ? (
      <div
        ...
        onClick={(e) => {
          // Close only if clicking on the overlay itself, not the card
  ...
  return (
    <>
      {/* Trigger Button - Only show if buttonName is provided */}
      {buttonName && (
        <button
      ...
      {/* Modal rendered via Portal so it always sits above every stacking context,
          including the sticky header, regardless of where this component lives in the tree */}
